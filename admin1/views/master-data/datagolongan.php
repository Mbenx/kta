            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <div class="showback"> 
                    ...
                    switch ($_GET['act']) {
                        default :
                            ?>
                            <a href="?page=datagolongan&act=add">
                                <button type="button" class="btn btn-warning">+ Tambah Golongan</button>
                            </a>
                        </div>
                        ...
                        <?php
                        $query = mysql_query("SELECT * FROM golongantb");
                        while ($row = mysql_fetch_array($query)) {
                            ?>
                            <tbody>
                                <tr>
                                    <td><a href="basic_table.html#"><?= $row['namagolongan'] ?></a></td>
                                    <td><?= $row['kdgolongan'] ?></td>
                                    <td>12000.00$ </td>
