            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <div class="showback"> 
                    ...
                    switch ($_GET['act']) {
                        default :
                            ?>
                            <a href="?page=dataanggota&act=add">
                                <button type="button" class="btn btn-warning">+ Tambah Anggota</button>
                            </a>
                        </div>
                        ...
                        <thead>
                            <tr>
                                <th><i class=""></i>No Tanda Anggota</th>
                                <th><i class=""></i>Nama</th>
                                <th><i class=""></i>Alamat</th>
                                <th><i class=""></i>Tempat, Tanggal Lahir</th>
                                <th><i class=""></i>Agama</th>
                                <th><i class=""></i>Golongan</th>
                                <th><i class=""></i>Gol Darah</th>
                                <th><i class=""></i>Pangkalan</th>
                                <th><i></i>Masa Berlaku</th>
                                <th><i class=" fa fa-edit"></i> Status</th>
                                <th></th>
                            </tr>
                        </thead>
                        <?php
                        $query = mysql_query("SELECT * FROM anggotatb");
                        while ($row = mysql_fetch_array($query)) {
                            ?>
                            <tbody>
                                <tr>
                                    <td><a href="basic_table.html#"><?= $row['nta'] ?></a></td>
                                    <td><?= $row['nama'] ?></td>
                                    <td><?= $row['alamat'] ?></td>
                                    <td><?= $row['tempatlahir'] ?> , <?= $row['tanggallahr'] ?></td>
                                    <td><?= $row['agama'] ?></td>
                                    <td><?= $row['golongan'] ?></td>
                                    <td><?= $row['darah'] ?></td>
                                    <td><?= $row['kodepangkalan'] ?></td>
                                    <td><?= $row['berlaku'] ?></td>
                ...
                case "add":
                    ?>
                    <p><a href="?page=dataanggota"><img src="../images/back.png"></a></p>
